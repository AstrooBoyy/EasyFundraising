...
export function AddPostForm({handlerCloseModal}) {
    ...
    const createProject = async () => {
        try {
            ...
            let base64data = new Buffer(buffer).toString('base64');
            ...
            let imgcid = null
            try {
                imgcid = (await storage.upload(imageFile)).substring(7)
            } catch (e) {
                console.log(e)
            }
            ...
            let infoCid = (await storage.upload(infoObject)).substring(7);
